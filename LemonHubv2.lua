...
game.StarterGui:SetCore("SendNotification", {
  ...
  Title = "LemonHub", -- the title (ofc)
  SubTitle = "by discord Lemon Community.  Join discord https://discord.gg/QEwnKVWEQJ "

  Text = "By : Discord Lemon", -- what the text says (ofc)

  Icon = "rbxassetid://16435279570", -- the image if u want.
...
Text2.Text = "Copy Zen Hub Discord"
...
Notification("Paste it in Browser")

setclipboard("https://discord.gg/QEwnKVWEQJ")
